...
- **Conversational Log:** `/agent/chat` routes messages to a LangGraph agent that can invoke tools to log or edit interactions.
...
5. **Check Compliance** (`check_compliance`)
   - Flags potential compliance risks (e.g., off-label claims, safety omissions).
